...
<div>
      ...
      <div>
        ...
        /* 
        <img src={`images/${currentWordInfo.image}`} alt={currentWordInfo.word} />
        <audio controls>
        ...
        <div>
          {options.map((option, index) => (
            <button
              ...
              className={`
                option
                ${showAnswer && option === currentWordInfo.answer ? 'correct' : ''}
                ${showAnswer && option === selectedOption && option !== currentWordInfo.answer ? 'incorrect' : ''}
              `}
